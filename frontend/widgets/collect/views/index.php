...
<div class="panel">
    <div class="panel-heading">
        <div class="panel-title poem-title">
            ...
            <div style="font-size: 2em" class="pull-right font-12"><?= $data['count'] ?> <i
            ...
            <div class="panel-body poem-body">
                <div class="row">
                    ...
                    <div class="col-lg-8 btn-group">
                        ...
                        <?php if ($config['own-center']) : ?>
                            <a class="delete-coll" href="javascript: void(0)"
                               data-url="<?= Url::to([$data['poem_url'], 'id' => $list['id']]) ?>">
                                <button style="border-radius: 50%;" class="btn btn-danger btn-quirk pull-right"><i
                                        class="fa fa-trash-o fa-lg"></i> 释放英灵
                                </button>
                            </a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="tags">
                    ...
                    <?php endif; ?>
                    <span
                        class="pull-right text-muted">收藏于: <?= date('Y-m-d H:i', $list['collect']['updated_at']) ?></span>
                </div>
